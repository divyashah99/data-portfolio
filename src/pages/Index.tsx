          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-lg mb-6 leading-relaxed">
                  <strong>Data & AI/ML Engineer</strong> with ~3 years of experience building production ETL pipelines, cloud data platforms, and AI-powered solutions across <strong>Financial Services</strong> and <strong>IT Consulting</strong>. MS in Data Analytics Engineering from <strong>Northeastern University</strong>. At <strong>Fidelity Investments</strong>, automated pipelines processing <strong>2M+ weekly records</strong>, reduced manual workflows from <strong>6 hours to fully automated</strong>, and maintained <strong>99.9% pipeline reliability</strong> for investment analysts. At <strong>TCS</strong>, designed star-schema data warehouses handling <strong>1,500+ daily transactions</strong>, achieved <strong>zero production defects</strong>, and cut reconciliation time from <strong>2 days to 2 hours</strong>. Skilled in <strong>Python, AWS, Snowflake, Spark, Airflow</strong>, and modern AI/ML frameworks—delivering scalable data solutions and AI-driven insights for investment strategies and operational efficiency.
              </p>
